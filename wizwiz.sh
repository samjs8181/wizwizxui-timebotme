...
git clone https://github.com/samjs8181/wizwizxui-timebotme.git /var/www/html/wizwizxui-timebot
...
echo "Folder created successfully!"
 ...
 cd /var/www/html/
 wget -O wizwizpanel.zip https://github.com/samjs8181/wizwizxui-timebotme/releases/download/10.3.1/wizwizpanel.zip
